...
echo LIBTORCH_DIR=%LIBTORCH_DIR% > env.bat
echo OPENVINO_DIR=%OPENVINO_DIR% >> env.bat
echo OPENVINO_TOKENIZERS_DIR=%OPENVINO_TOKENIZERS_DIR% >> env.bat
echo OPENCL_SDK_DIR=%OPENCL_SDK_DIR% >> env.bat
echo WHISPER_CLONE_DIR=%WHISPER_CLONE_DIR% >> env.bat
echo AUDACITY_CLONE_DIR=%AUDACITY_CLONE_DIR% >> env.bat
